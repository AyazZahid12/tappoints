        ...
        <div>
          <div style={{ marginBottom: 20, textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 13, color: '#0A1A1460', marginTop: 8, lineHeight: 1.6 }}>
              Cada vez que visitas {negocioNombre}, el empleado generará un QR.
              Escanéalo para sumar{' '}
          ...
          <div style={{ marginTop: 16, fontSize: 13, color: '#0A1A1460', lineHeight: 1.6, textAlign: 'center' }}>
